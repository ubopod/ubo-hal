...
class AnimatedGif:
    ...
    def play(self):
        ...
        _prev_advance_btn_val = 0# self.advance_button.value
        _prev_back_btn_val = 0 #self.back_button.value
        ...
        while True:
            for frame_object in self._frames:
                ...
                _cur_advance_btn_val = 0 # self.advance_button.value
                _cur_back_btn_val = 0 # self.back_button.value
